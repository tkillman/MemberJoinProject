...
<form method="post" action="inputPro.do" name="userinput" onSubmit="return checkIt()" enctype="multipart/form-data">
  <table width="600" border="1" cellspacing="0" cellpadding="3" align="center" >
    ...
    <tr>
      <td width="200"> 사진</td>
      <td width="400">
        <input type="file" name="photo" size="10" maxlength="12"  onchange="imageURL(this)">
      <img alt="" src="" id="replaceMe">
      </td>
